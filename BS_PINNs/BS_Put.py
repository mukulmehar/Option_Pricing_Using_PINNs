...
# print(model(torch.tensor(np.array([5.0]), dtype=torch.float32).to(device), torch.tensor(np.array([1.0]), dtype=torch.float32).to(device)))
# print(bs_eq_exact_solution(np.array([5.0]), np.array([1.0])))

# print(model(torch.tensor(np.array([2.0]), dtype=torch.float32).to(device), torch.tensor(np.array([1.0]), dtype=torch.float32).to(device)))
# print(bs_eq_exact_solution(np.array([2.0]), np.array([1.0])))

# print(model(torch.tensor(np.array([5.0]), dtype=torch.float32).to(device), torch.tensor(np.array([0.5]), dtype=torch.float32).to(device)))
# print(bs_eq_exact_solution(np.array([5.0]), np.array([0.5])))

# print(model(torch.tensor(np.array([2.0]), dtype=torch.float32).to(device), torch.tensor(np.array([0.5]), dtype=torch.float32).to(device)))
# print(bs_eq_exact_solution(np.array([2.0]), np.array([0.5])))
